...
if __name__ == '__main__':
    ...
    t_model(batch_size=64, epoch=0, model_name="resnet18")

    for e in range(1, 11):
        start_time = time.time()
        train_model(batch_size=64, start_epoch=e - 1, end_epoch=e, learning_rate=0.001, model_name="resnet18")
        end_time = time.time()
        print(f"Training time for epoch {e} = {end_time - start_time:.2f}s")
        t_model(batch_size=64, epoch=e, model_name="resnet18")
